...
public enum ExceptionCode {
    ...
    FOLLOW_NOT_FOUND(HttpStatus.NOT_FOUND, ClientExceptionCode.FOLLOW_NOT_FOUND, "팔로우가 존재하지 않습니다."),

    // 409 Conflict
    LIKE_ALREADY_EXISTS(HttpStatus.CONFLICT, ClientExceptionCode.LIKE_ALREADY_EXISTS, "이미 좋아요를 누르셨습니다."),
    ALREADY_FOLLOWED(HttpStatus.CONFLICT, ClientExceptionCode.ALREADY_FOLLOWED, "이미 팔로우 되어 있습니다."),
