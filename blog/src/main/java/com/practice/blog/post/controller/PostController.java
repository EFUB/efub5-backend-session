...
public class PostController {
    ...
    // 게시물 생성
    @PostMapping
    public ResponseEntity<Void> createdPost(@Valid @RequestBody PostCreateRequest request) {
    ...
    // 게시물 내용 수정
    @PatchMapping("/{id}")
    public ResponseEntity<Void> updatePostController(@PathVariable("id") Long postId,
