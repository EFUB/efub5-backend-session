...
public class AccountController {
    ...
    public ResponseEntity<AccountResponseDto> updateAccount(@PathVariable("accountId") Long accountId, @RequestBody @Valid BioUpdateRequestDto requestDto) {
    ...
    public ResponseEntity<String> deleteAccount(@PathVariable("accountId") Long accountId) {
        ...
        return ResponseEntity.ok("message : 성공적으로 탈퇴");
    }
